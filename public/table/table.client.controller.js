 ...
 */
table.controller("tableController",['$rootScope','$scope', '$http','$timeout','$mdDialog','$state',
    function ($rootScope,$scope, $http,$timeout,$mdDialog,$state) {
    var cve ;
        console.log($rootScope.prevent);
        console.log($rootScope.prevent === undefined);
       if($rootScope.prevent === undefined || $rootScope.prevent){
           $state.go('secharts');
       }
